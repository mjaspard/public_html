...
<!--	<div class="warp">-->
        <div class="child">
	     	...
	     	<section class="child-V-50">
                ...
                <p>
                <?php echo "<b>Current station status:</b> ".$CurrentStatusdisp."<br>" ?><br>
                <?php echo GetSleepInfo()  ?><br>
                <?php echo "<b>Battery voltage =</b> <a id=\"GetVoltage\"></a>";?><br>
                <?php echo "<b>Hours of activation:</b> ".$WakeUp."H to ".$StartSleep."H" ?><br>
                <?php echo "<b>Last data:</b> ".$readings_time[0] ?>
                </p>
            </section>
